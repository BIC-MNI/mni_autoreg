...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' */
void derivatives(Real r[3][3][3], /* compute quadratic fit to this region     */ 
		 Real c[9])	  /* store derivatives here 		      */

{
  ...
  Real	*p21, *p22, *p23, *p24, *p25;
  Real	*p31, *p32, *p33, *p34, *p35;
  Real	*p41, *p42, *p43, *p44, *p45;
  Real	*p51, *p52, *p53, *p54, *p55;
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''' */
int  test_max(Real c[9])

{
  Real  d1, d2, d3;
  int    test;
  Real cof11, cof12, cof13;
  Real cuu, cvv, cww, cuv, cuw, cvw;
