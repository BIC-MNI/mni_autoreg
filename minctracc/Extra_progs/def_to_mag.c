...
#ifndef lint
static char rcsid[]="$Header: /private-cvsroot/registration/mni_autoreg/minctracc/Extra_progs/def_to_mag.c,v 1.2 2002-03-26 14:15:28 stever Exp $";
#endif
...
public BOOLEAN get_magnitude(General_transform *trans,
                             int voxel[],
                             Real *dist);
